 ...
 */
class Manage_permissions extends Admin_Controller {
	...
	function __construct()
	{
		...
		$this->current = 'manage_permissions';
		$this->is_admin();
	}
	...
	function index()
	{
		...
		{
			redirect('admin/account_profile');
		}
		...
		$this->render_page('admin/permissions/manage_permissions', $data);
	}
	...
	function save($id=null)
	{
		...
		// Load manage permissions view
		$this->render_page('admin/permissions/manage_permissions_save', $data);
	}
