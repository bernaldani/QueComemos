 ...
 */
class Manage_roles extends Admin_Controller {
	...
	function __construct()
	{
		...
		$this->current = 'manage_roles';
		$this->page_title = 'Manage Roles';
		$this->is_admin();
	}
	...
	function index()
	{
		...
		$this->render_page('admin/roles/manage_roles', $data);
	}
	...
	function save($id=null)
	{
		...
		// Load manage roles view
		$this->render_page('admin/roles/manage_roles_save', $data);
	}
