	...
	<?php if ($facebook_links) : ?>
		<?php foreach ($facebook_links as $facebook_link) : ?>
            ...
            <div class="row">
                <div class="span1">
                    <img src="<?php echo site_url(RES_DIR.'/images/auth_icons/facebook.png');?>" alt="<?php echo lang('connect_facebook'); ?>"
	...
	<?php if ($twitter_links) : ?>
		<?php foreach ($twitter_links as $twitter_link) : ?>
            ...
            <div class="row">
                <div class="span1">
                    <img src="<?php echo site_url(RES_DIR.'/images/auth_icons/twitter.png');?>" alt="<?php echo lang('connect_twitter'); ?>" title="<?php echo lang('connect_twitter'); ?>"
                         width="40"/>
                </div>
                <div class="span7">
	...
	<?php if ($openid_links) : ?>
		<?php foreach ($openid_links as $openid_link) : ?>
            ...
            <div class="row">
                <div class="span1">
                    <img src="<?php echo site_url(RES_DIR.'/images/auth_icons/'.$openid_link->provider.'.png');?>" alt="<?php echo lang('connect_'.$openid_link->provider); ?>"
                         width="40"/>
                </div>
                <div class="span7">
