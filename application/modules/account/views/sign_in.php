...
<div class="span6">
    ...
    <div class="well">
        ...
        <div class="control-group">
            <div >
                <label for="sign_in_remember" class="checkbox">
        ...
        <div>
			<?php echo form_button(array('type' => 'submit', 'class' => 'btn btn-warning btn-lg pull-right', 'content' => '<span class="glyphicon glyphicon-lock"></span> '.lang('sign_in_sign_in'))); ?>
        </div>

        <p class="pull-left"><?php echo anchor('account/forgot_password', lang('sign_in_forgot_your_password')); ?><br/>
