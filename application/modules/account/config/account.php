...
$config['password_reset_secret'] 		= 'zkpynYfMKoCvBzGAmMNjU5jwEvZpSIs54idAdb1MXJRUkOoW3lnwquLrl17qJys';
$config['password_reset_email'] 		= 'no-responder@quecomemos.com.py';
