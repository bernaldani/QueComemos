...
class Reset_password extends My_Controller {
	...
	function index($id=null)
	{
		...
		if ($recaptcha_result !== TRUE)
		{
			...
			$this->render_page('account/reset_password_captcha', isset($data) ? $data : NULL);
			return;
		}
		...
		$this->render_page('account/reset_password_unsuccessful', isset($data) ? $data : NULL);
	}
