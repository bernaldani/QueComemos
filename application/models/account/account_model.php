...
class Account_model extends CI_Model {
	 ...
	 */
	function create($username = NULL, $email, $password = NULL)
	{
		...
		$this->db->insert('a3m_account', array('username' => '', 'email' => $email, 'password' => isset($hashed_password) ? $hashed_password : NULL, 'createdon' => mdate('%Y-%m-%d %H:%i:%s', now())));
